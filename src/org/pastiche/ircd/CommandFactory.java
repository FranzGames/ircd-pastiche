...
/**
 * <p>
 * The CommandFactory creates Command objects by parsing a String that contains
 * a (possibly) valid ircd command. The Factory pattern allows us to plug in,
 * chop, change and whatever the entire operations of a server even between
 * rehashes.
 *
 * <p>
 * There is a possible performance hit in getCommandFactory(String) - it adds an
 * extra hashtable lookup every time someone needs to access the factory.
 * Perhaps there's a better way to do this? Certainly, we don't want any other
 * structures caching CommandFactory objects, or a rehash could send the server
 * insane.
 *
 */
public class CommandFactory {
   ...
   private CommandFactory(Map<String, Command> commandMap, Command defaultCommand) {
      this.commandMap = commandMap;
      this.defaultCommand = defaultCommand;
   }

   public java.util.Iterator<String> getAvailableCommands() {
