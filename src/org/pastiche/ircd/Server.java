...
/**
 * <p>
 * Represents the state of the current server. It might be necessary to split
 * off a separate Network object that represents the network as a whole, but
 * right now it's all in here.
 */
public class Server implements Target {

   private String networkName = "FooBar";
   private String serverInfo = "This is hard-coded";
   private Map<String, Target> connectedTargets = new java.util.HashMap<String, Target>();
   private Map<String, Target> networkUsers = new java.util.HashMap<String, Target>();
   private Map<String, Channel> channels = new java.util.HashMap<String, Channel>();
   ...
   /**
    * Note: This method assumes that a valid username, servername and channel
    * name can not overlap. This is probably a bad thing.
    */
   ...
   public java.util.Set<Target> getVisibleLocalTargets() {
      Collection<Target> coll = connectedTargets.values();
