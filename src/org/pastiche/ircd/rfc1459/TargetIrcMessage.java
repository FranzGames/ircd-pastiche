 ...
 * @author pfranz
 */
public class TargetIrcMessage extends IrcMessage {
   String targetName;
   
   public TargetIrcMessage (IrcMessage msg, String name) {
      super (msg.getCommand(), msg.getMessage());
      
      this.targetName = name;
      this.parameterSep = msg.getParameterSeparator();
      
      this.parameters.addAll(msg.getParameters());
      this.postParameters.addAll(msg.getPostParameters());
   }
