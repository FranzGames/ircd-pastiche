...
/**
 * <p>This class officially annoys me. I don't know how to do user capabilities
...
public Channel(Server server, String name) throws org.pastiche.ircd.BadChannelNameException {
	super(server, name);
}
...
public static org.pastiche.ircd.Channel findOrCreateChannel(Server server, String name) {
	org.pastiche.ircd.Channel channel = null;
	...
	try {
		return new Channel(server, name);
 ...
 * Creation date: (25/02/2001 10:40:23 AM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (25/02/2001 12:26:17 AM)
 * @return boolean
 */
...
/**
 * Insert the method's description here.
 * Creation date: (25/02/2001 12:06:15 AM)
 * @return boolean
 */
...
/**
 * Insert the method's description here.
 * Creation date: (24/02/2001 10:46:16 PM)
 * @return boolean
 */
